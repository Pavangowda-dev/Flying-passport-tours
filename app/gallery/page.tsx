...
import { getGalleryUrl } from "@/lib/image-url";
...
// ---------------------------
const galleryImages = [
  { id: 1, src: getGalleryUrl("travellers%20(1).png"), alt: "Group travel experience" },
  { id: 2, src: getGalleryUrl("travellers%20(2).png"), alt: "Travel memories" },
  { id: 3, src: getGalleryUrl("travellers%20(3).png"), alt: "Adventure moments" },
  { id: 4, src: getGalleryUrl("travellers%20(4).png"), alt: "Cultural exploration" },
  { id: 5, src: getGalleryUrl("travellers%20(5).png"), alt: "Travel experiences" },
  { id: 6, src: getGalleryUrl("travellers%20(6).png"), alt: "Group adventures" },
  { id: 7, src: getGalleryUrl("travellers%20(7).png"), alt: "Travel highlights" },
  { id: 8, src: getGalleryUrl("travellers%20(8).png"), alt: "Destination visits" },
  { id: 9, src: getGalleryUrl("travellers%20(9).png"), alt: "Travel moments" },
  { id: 10, src: getGalleryUrl("travellers%20(10).png"), alt: "Group travel" },
  { id: 11, src: getGalleryUrl("travellers%20(11).png"), alt: "Historic monuments" },
  { id: 12, src: getGalleryUrl("travellers%20(12).png"), alt: "Scenic destinations" },
  { id: 13, src: getGalleryUrl("travellers%20(13).png"), alt: "Safari adventures" },
  { id: 14, src: getGalleryUrl("travellers%20(14).png"), alt: "Ancient ruins" },
  { id: 15, src: getGalleryUrl("travellers%20(15).png"), alt: "Desert landscapes" },
  { id: 16, src: getGalleryUrl("travellers%20(16).png"), alt: "Cultural experiences" },
  { id: 17, src: getGalleryUrl("travellers%20(17).png"), alt: "Archaeological sites" },
  { id: 18, src: getGalleryUrl("travellers%20(18).png"), alt: "Group celebrations" },
  { id: 19, src: getGalleryUrl("travellers%20(19).png"), alt: "Mountain adventures" },
  { id: 20, src: getGalleryUrl("travellers%20(20).png"), alt: "Coastal experiences" },
];
